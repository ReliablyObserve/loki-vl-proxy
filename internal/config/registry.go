...
var categories = []Category{
	...
	{"compatibility", []string{"label-style", "metadata-", "emit-structured-metadata", "extra-label-fields", "stream-fields", "field-mapping", "derived-fields", "patterns", "translate-otel", "backend-min-version", "backend-allow-unsupported-version", "backend-version-strict", "tail", "drilldown-", "align-queries-with-step"}},
